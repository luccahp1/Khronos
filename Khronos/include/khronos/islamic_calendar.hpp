...
namespace khronos {
	...
	inline bool is_islamic_leapyear(year_t y) { long long c = (y % 30 + 30) % 30; static const bool leap[30] = { false,true,false,true,false,false,true,false,true,false,false,true,false,true,false,false,true,false,true,false,false,true,false,true,false,false,true,false,true,false }; return leap[c]; }
